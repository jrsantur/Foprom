...
import pe.juabsa.cipca.foprom.util.*
import pe.juabsa.cipca.foprom.util.ApiUtil.successCall
...
class RepoRepositoryTest {
    ...
    private val service = mock(FopromService::class.java)
    @Rule
    @JvmField
    ...
    @Before
    fun init() {
        val db = mock(FopromDb::class.java)
