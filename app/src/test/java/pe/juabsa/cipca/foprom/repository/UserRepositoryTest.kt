...
import pe.juabsa.cipca.foprom.util.ApiUtil
import pe.juabsa.cipca.foprom.util.InstantAppExecutors
...
class UserRepositoryTest {
    ...
    private val fopromService = mock(FopromService::class.java)
    private val repo = UserRepository(InstantAppExecutors(), userDao, fopromService)
