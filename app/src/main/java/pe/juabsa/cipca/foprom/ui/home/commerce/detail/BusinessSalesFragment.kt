 ...
 * Use the [BusinessSalesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BusinessSalesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val rootView =  inflater.inflate(R.layout.fragment_business_sales, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment BusinessSalesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(page: Int, isLast: Boolean) =
                BusinessSalesFragment().apply {
