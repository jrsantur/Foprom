 ...
 * Use the [BusinessShoppingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BusinessShoppingFragment : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    val rootView =  inflater.inflate(R.layout.fragment_business_shopping, container, false)
  ...
  companion object {
     ...
     * @return A new instance of fragment BusinessShoppingFragment.
     */
    // TODO: Rename and change types and number of parameters
    @JvmStatic
    fun newInstance(page: Int, isLast: Boolean) =
            BusinessShoppingFragment().apply {
