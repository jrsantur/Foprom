 ...
 * Use the [BusinessDebtsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BusinessDebtsFragment : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    val  rootView = inflater.inflate(R.layout.fragment_business_debts, container, false)
  ...
  companion object {
     ...
     * @return A new instance of fragment BusinessDebtsFragment.
     */
    // TODO: Rename and change types and number of parameters
    @JvmStatic
    fun newInstance(page: Int, isLast: Boolean) =
            BusinessDebtsFragment().apply {
