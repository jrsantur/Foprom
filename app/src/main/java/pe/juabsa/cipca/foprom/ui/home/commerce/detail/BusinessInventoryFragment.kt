 ...
 * Use the [BusinessInventoryFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BusinessInventoryFragment : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    val rootView =  inflater.inflate(R.layout.fragment_business_inventory, container, false)
  ...
  companion object {
     ...
     * @return A new instance of fragment BusinessInventoryFragment.
     */
    // TODO: Rename and change types and number of parameters
    @JvmStatic
    fun newInstance(page: Int, isLast: Boolean) =
            BusinessInventoryFragment().apply {
